...
for model_name in ["sk", "sk_fcp"]:  # add useless coord ring models
...
for model_name, model in model_dict.items():
  environment_stage = MultiAgentEnvStage(
    name=f"{model_name}_counter_circuit",
    web_env=jax_web_env,
    action_keys=action_keys,
    action_to_name=action_to_name,
    env_params=env_params,
  ...
  survey_stage = make_survey_stage(f"{model_name} Counter Circuit 설문")

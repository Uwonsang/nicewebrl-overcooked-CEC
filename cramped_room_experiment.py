...
instruction_block = Block(
  ...
  randomize=False,
  name="cramped_room_instructions",
)
...
for model_name, model in model_dict.items():
  environment_stage = MultiAgentEnvStage(
    name=f"{model_name}_cramped_room",
    web_env=jax_web_env,
    action_keys=action_keys,
    action_to_name=action_to_name,
    env_params=env_params,
  ...
  survey_stage = make_survey_stage(f"{model_name} Cramped Room 설문")
  ...
  env_block = Block(
    ...
    randomize=False,
    name=f"cramped_room_{model_name}_block",
  )

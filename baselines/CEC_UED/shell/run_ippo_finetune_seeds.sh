...
if [[ $# -lt 1 ]]; then
    ...
    echo "Example: $0 64 counter_circuit_9,coord_ring_9" >&2
...
CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-/app/nas/models/ICRL/CEC/${FINETUNE_NUM_ENVS}}"
...
for LAYOUT in "${LAYOUTS[@]}"; do
    for SEED in 0 1 2 3 4 5; do
        echo "Starting IPPO fine-tuning: layout=${LAYOUT}, seed=${SEED}, num_envs=${FINETUNE_NUM_ENVS}, run_id=${RUN_ID}"
